...
class StudentApplicationForm extends StatefulWidget {
  @override
  _StudentApplicationFormState createState() => _StudentApplicationFormState();
}

class _StudentApplicationFormState extends State<StudentApplicationForm> {
  String pdfUrl = 'https://msebeccs.com/pdf/student-application.pdf';
  String? filePath;
